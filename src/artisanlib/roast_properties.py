...
class editGraphDlg(ArtisanResizeablDialog):
    ...
    def __init__(self, parent = None, aw = None):
        ...
        self.setModal(True)
        # roasterhub edited
        self.setWindowTitle(QApplication.translate("Form Caption", "Roast Properties - Roasterhub EXT",None))
...
#        self.cooledit.setFocusPolicy(Qt.NoFocus)
        ...
        # edit roasterhub start
        self.roastpropertiesRHUBSellFromMachine = QCheckBox(
            QApplication.translate("CheckBox", "Sell From Machine", None)
        )
        # edit roasterhub end
...
#        tab1Layout.addStretch()
        ...
        # roasterhub edited start
        tab5Layout = QVBoxLayout()
        # tab5Layout.addWidget(self.eventtable)
        tab5Layout.addLayout(anotationLayout)
        tab5Layout.setContentsMargins(5, 5, 5, 5)  # left, top, right, bottom
        # roasterhub edited end
        ...
        self.TabWidget.addTab(C5Widget, QApplication.translate("Tab", "Roasterhub", None))
        # roasterhub edited end

...
Caption "${PRODUCT_NAME} (Roasterhub ext) Installer"
VIProductVersion ${PRODUCT_VERSION}
VIAddVersionKey ProductName "${PRODUCT_NAME}"
VIAddVersionKey Comments "Installer for Artisan (Roasterhub ext)"
...
Section "MainSection" SEC01
  ...
  CreateShortCut "$SMPROGRAMS\Artisan\Artisan.lnk" "$INSTDIR\artisan\artisan.exe"
  CreateShortCut "$DESKTOP\Artisan.lnk" "$INSTDIR\artisan\artisan.exe"
SectionEnd
...
Section -Post
  ...
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\artisan\artisan.exe"
...
Section Uninstall
  ...
  Delete "$INSTDIR\artisan\artisan.exe"
  Delete "$INSTDIR\artisan\artisan.png"
  Delete "$INSTDIR\artisan\LICENSE.txt"
  Delete "$INSTDIR\artisan\python34.dll"
  Delete "$INSTDIR\artisan\README.txt"
  Delete "$INSTDIR\artisan\w9xpopen.exe"
  Delete "$INSTDIR\artisan\artisanAlarms.ico"
  Delete "$INSTDIR\artisan\artisanProfile.ico"
  Delete "$INSTDIR\artisan\artisanPalettes.ico"
  Delete "$INSTDIR\artisan\artisanTheme.ico"
  Delete "$INSTDIR\artisan\artisanWheel.ico"
  Delete "$INSTDIR\artisan\artisanSettings.ico"
  Delete "$INSTDIR\artisan\Humor-Sans.ttf"
  Delete "$INSTDIR\artisan\alarmclock.eot"
  Delete "$INSTDIR\artisan\alarmclock.svg"
  Delete "$INSTDIR\artisan\alarmclock.ttf"
  Delete "$INSTDIR\artisan\alarmclock.woff"
  Delete "$INSTDIR\artisan\artisan.tpl"
  Delete "$INSTDIR\artisan\bigtext.js"
  Delete "$INSTDIR\artisan\sorttable.js"
  Delete "$INSTDIR\artisan\report-template.htm"
  Delete "$INSTDIR\artisan\roast-template.htm"
  Delete "$INSTDIR\artisan\ranking-template.htm"
  Delete "$INSTDIR\artisan\jquery-1.11.1.min.js"
  Delete "$INSTDIR\artisan\qt.conf"
  Delete "$INSTDIR\artisan\vcredist_x86.exe"
  ...
  RMDir /r "$INSTDIR\artisan\plugins"
  RMDir /r "$INSTDIR\artisan\lib"
  RMDir /r "$INSTDIR\artisan\mpl-data"
  RMDir /r "$INSTDIR\artisan\translations"
  RMDir /r "$INSTDIR\artisan\Wheels"
  RMDIR /r "$INSTDIR\artisan\Themes"

  RMDir /r "$INSTDIR\artisan\gevent-1.4.0-py3.7.egg-info"
  RMDir /r "$INSTDIR\artisan\gevent-1.4.0-py3.8.egg-info"
  RMDir /r "$INSTDIR\artisan\gevent-1.5.0-py3.8.egg-info"
  RMDir /r "$INSTDIR\artisan\lxml"

  RMDir /r "$INSTDIR\artisan\gevent"
  RMDir /r "$INSTDIR\artisan\matplotlib"
  RMDir /r "$INSTDIR\artisan\numpy"
  RMDir /r "$INSTDIR\artisan\scipy"
  RMDir /r "$INSTDIR\artisan\win32com"
  RMDir /r "$SMPROGRAMS\artisan\Artisan"
  RMDir /r "$SMPROGRAMS\artisan"
  RMDir /r "$INSTDIR"

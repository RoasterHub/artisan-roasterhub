...
# START ROASTERHUB MENU
ROASTERHUB_MENU = QApplication.translate("Menu", "Roasterhub", None)
ROASTERHUB_MENU_ABOUT = QApplication.translate("Menu", "About Roasterhub", None)
ROASTERHUB_MENU_CONFIG = QApplication.translate("Config", "Config", None)
# END ROASTERHUB MENU
